    ...
    <div class="mfp-with-anim woodmart-promo-popup" style="background-color: #ffff;">
        <div class="pop-job-details" id="jobHandler">
            ...
            <div class="pop-job-action">
                <button class="job-apply-btn" id="jobApplyBtn" data-id="">Apply Now <svg width="30" height="12" viewBox="0 0 30 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0 6.35365H27.5779L23.5962 10.4727L24.4909 11.3982L30 5.6991L24.4909 0L23.5962 0.925524L27.5779 5.04456H0V6.35365Z" fill="white"/></svg></button>
            </div>
        </div>
    </div>
</div>